...
{
    public class UserClaimsAddedEventFormatter<TKey> : IMessagePackFormatter<UserClaimsAdded<TKey>>
        where TKey : IEquatable<TKey>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, UserClaimsAdded<TKey> value, IFormatterResolver formatterResolver)
        {
            var keyFormatter = formatterResolver.GetFormatter<TKey>();
            var claimFormatter = formatterResolver.GetFormatter<Claim>();
