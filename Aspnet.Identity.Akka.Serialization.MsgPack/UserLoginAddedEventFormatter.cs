...
{
    public class UserLoginAddedEventFormatter<TKey> : IMessagePackFormatter<UserLoginAdded<TKey>>
    where TKey : IEquatable<TKey>
    {
        public UserLoginAdded<TKey> Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            ...
            return new UserLoginAdded<TKey>(key, new Model.ImmutableUserLoginInfo(loginProvider, providerKey, displayName));
        }
